...
import { Movie, MovieItem, MovieSearchItem } from '../../models/movie.model';

function formatMovieItem(movie: Partial<Movie>): MovieItem {
...
function formatInternalMovieSearchItem(movie: Partial<Movie>): MovieSearchItem {
